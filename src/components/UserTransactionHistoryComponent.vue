  ...
  <div class="container">
    <form class="row g-3">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="fromIban" placeholder="NLxxINHO0xxxxxxxxx" v-model="fromIban" />
      </div>
      <div class="form-group col-md-6">
        <label for="toIban">To IBAN:</label>
        <input type="text" class="form-control" id="toIban" placeholder="NLxxINHO0xxxxxxxxx" v-model="toIban" />
      </div>
      <div class="form-group col-md-6">
        <label for="transactionType">Transaction Type:</label>
        <select class="form-select" id="transactionType" v-model="transactionType">
      ...
      <button type="submit" class="btn btn-primary col-12" @click="getTransactions">Filter</button>
    </form>
    <div>
      <table class="table">
        <thead>
