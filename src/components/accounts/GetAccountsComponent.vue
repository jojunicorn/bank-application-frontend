<template>
  <div class="ml-3 mt-3">
    ...
    <div class="form-group row">
      <label for="ibanSearch" class="col-sm-2 col-form-label"
      ...
      <div class="col-md-10">
        <div class="input-group">
          ...
          <div class="input-group-append">
            <button @click="fetchAccounts" class="btn btn-primary">
              Search account
            </button>
          </div>

          <div class="ml-5 pl-5 mr-5">
            <router-link :to="'/accountsCreate'" class="btn btn-success"
      ...
      <table class="table table-bordered table-striped my-3">
        ...
        <tbody>
          <tr v-for="account in accounts" :key="account.id">
            ...
            <td
              :class="{
                'success-message': account.accountStatus === 'ACTIVE',
                'error-message': account.accountStatus === 'INACTIVE',
              }"
            >
            ...
            <td>
              <div class="btn-group" role="group">
                <a
                  @click="goToEditStatus(account.iban)"
                  target="_blank"
                  class="btn btn-warning mt-3 mr-3"
                  >Update account status</a
                >
                <a
                  @click="goToEditLimit(account.iban)"
                  target="_blank"
                  class="btn btn-warning mt-3 mr-3"
